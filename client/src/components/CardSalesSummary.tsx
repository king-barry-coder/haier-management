...
const CardSalesSummary = () => {
  ...
  return (
    <div className="bg-white dark:bg-black border-1 border-gray-900 shadow-md rounded-2xl flex flex-col justify-between ">
      {isLoading ? (
        ...
        <>
          ...
          <div>
            <div className="flex justify-between items-center mb-6 px-7 mt-5">
              ...
              <select
                className="shadow-sm border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 p-2 rounded"
                value={timeframe}
            ...
            <ResponsiveContainer width="100%" height={350} className="px-7">
              ...
              >
                ...
                <YAxis
                  ...
                  tick={{ fontSize: 12, dx: -1, fill: isDarkMode ? "#d1d5db" : "#4b5563" }}
                  tickLine={false}
                  axisLine={false}
                />
                <Tooltip
